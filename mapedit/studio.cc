...
// Mode menu items:
constexpr static const std::array mode_names{"move",           "paint",         "paint-with-chunks",
...
C_EXPORT void app_open_game_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->open_game_dialog();
}

C_EXPORT void app_new_game_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->new_game();
}

C_EXPORT void app_new_mod_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->open_game_dialog(true);
}

C_EXPORT void app_connect_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->connect_to_server();
}

C_EXPORT void app_save_all_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->save_all();
}

C_EXPORT void app_new_shapes_file_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->new_shape_file(false);
}

C_EXPORT void app_new_shape_file_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->new_shape_file(true);
}

C_EXPORT void app_save_map_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->write_map();
}

C_EXPORT void app_read_map_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->read_map();
}

C_EXPORT void app_write_minimap_menu_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->write_minimap();
}

C_EXPORT void app_play_audio_menu_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->play_audio_dialog();
}

C_EXPORT void app_save_shape_info_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->write_shape_info();
}

C_EXPORT void app_reload_usecode_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->reload_usecode();
}

C_EXPORT void app_compile_usecode_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->compile();
}

C_EXPORT void app_fix_old_shape_info_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
...
C_EXPORT void app_save_groups_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->save_groups();
}

C_EXPORT void app_save_combos_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->save_combos();
}

C_EXPORT void app_save_presets_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->save_shape_presets();
	(static_cast<ExultStudio*>(user_data))->save_npc_presets();
}

C_EXPORT void app_reload_css_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->reload_css();
}

C_EXPORT void app_preferences_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->open_preferences();
}

C_EXPORT void app_cut_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	unsigned char z = 0;
	(static_cast<ExultStudio*>(user_data))->send_to_server(Exult_server::cut, &z, 1);
}

C_EXPORT void app_copy_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	unsigned char o = 1;
	(static_cast<ExultStudio*>(user_data))->send_to_server(Exult_server::cut, &o, 1);
}

C_EXPORT void app_paste_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	(static_cast<ExultStudio*>(user_data))->send_to_server(Exult_server::paste);
}

C_EXPORT void app_properties_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	unsigned char o = 0;    // 0=npc/egg properties.
	(static_cast<ExultStudio*>(user_data))->send_to_server(Exult_server::edit_selected, &o, 1);
}

C_EXPORT void app_basic_properties_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	unsigned char o = 1;    // 1=basic object properties.
	(static_cast<ExultStudio*>(user_data))->send_to_server(Exult_server::edit_selected, &o, 1);
}

C_EXPORT void app_mode_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
...
C_EXPORT void app_unused_shapes_action(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	if (EStudio::Prompt("Finding unused shapes may take several minutes\nProceed?", "Yes", "No") != 0) {
		return;
	}
	(static_cast<ExultStudio*>(user_data))->send_to_server(Exult_server::unused_shapes);
}
...
C_EXPORT void on_tile_grid_button_toggled(GtkCheckButton* button, gpointer user_data) {
	ignore_unused_variable_warning(user_data);
	ExultStudio::get_instance()->set_tile_grid(gtk_check_button_get_active(button));
}
...
C_EXPORT void on_edit_terrain_button_toggled(GtkCheckButton* button, gpointer user_data) {
	ignore_unused_variable_warning(user_data);
	ExultStudio::get_instance()->set_edit_terrain(gtk_check_button_get_active(button));
}

/*
 *  Configure main window.
 */
static gboolean on_response(GtkDialog* dialog, gint response_id, gpointer user_data) {
...
gint gtk_dialog_run(GtkDialog* w) {
	...
	g_signal_connect(G_OBJECT(w), "response", G_CALLBACK(on_response), reinterpret_cast<gpointer>(&response));
	gtk_window_set_transient_for(GTK_WINDOW(w), GTK_WINDOW(ExultStudio::get_instance()->get_widget("main_window")));
 ...
 */
C_EXPORT gboolean on_main_window_delete_event(GtkWidget* widget, gpointer user_data) {
...
C_EXPORT void on_main_window_destroy_event(GtkWidget* widget, gpointer user_data) {
	ignore_unused_variable_warning(widget, user_data);
 ...
 *  "Exit" in main window.
 */
C_EXPORT void on_main_window_quit(GSimpleAction* action, GVariant* parameter, gpointer user_data) {
	ignore_unused_variable_warning(action, parameter);
	auto* studio = static_cast<ExultStudio*>(user_data);
 ...
 */
C_EXPORT gboolean on_main_window_focus_in_event(GtkWidget* widget, GdkEvent* event, gpointer user_data) {
...
C_EXPORT void app_open_npc_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_open_egg_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_open_barge_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_locator_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_new_combo_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_newmap_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_map_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
C_EXPORT void app_set_game_information_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);

static GActionEntry app_entries[] = {
		// clang-format off
		{            "new-game",             app_new_game_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{             "new-mod",              app_new_mod_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{           "open-game",            app_open_game_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{            "save-all",             app_save_all_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{     "new-shapes-file",      app_new_shapes_file_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{      "new-shape-file",       app_new_shape_file_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{            "save-map",             app_save_map_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{     "save-shape-info",      app_save_shape_info_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{         "save-groups",          app_save_groups_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{         "save-combos",          app_save_combos_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{        "save-presets",         app_save_presets_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{            "read-map",             app_read_map_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{       "write-minimap",   app_write_minimap_menu_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{          "play-audio",      app_play_audio_menu_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{      "reload-usecode",       app_reload_usecode_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{          "reload-css",           app_reload_css_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{             "connect",              app_connect_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{         "preferences",          app_preferences_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		...
		{          "properties",           app_properties_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{    "basic-properties",     app_basic_properties_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{            "open-egg",             app_open_egg_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{            "open-npc",             app_open_npc_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{          "open-barge",           app_open_barge_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{"set-game-information", app_set_game_information_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{                "mode",                         nullptr,     "s",     "'move'", app_mode_action, {0, 0, 0}},
		{             "locator",              app_locator_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{           "new-combo",            app_new_combo_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{       "unused-shapes",        app_unused_shapes_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{     "compile-usecode",      app_compile_usecode_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
		{  "fix-old-shape-info",   app_fix_old_shape_info_action, nullptr,      nullptr,         nullptr, {0, 0, 0}},
...
ExultStudio::ExultStudio(int argc, char** argv)
	...
	application = gtk_application_new("org.Exult.ExultStudio", G_APPLICATION_DEFAULT_FLAGS);
...
#	endif
	...
	cout << endl
		 ...
		 << " running with GTK+ " << gtk_get_major_version() << "." << gtk_get_minor_version() << "." << gtk_get_micro_version()
		 << endl
		 << endl;
	setup_program_paths();
#ifdef _WIN32
	...
	gtk_icon_theme_add_search_path(gtk_icon_theme_get_for_display(gdk_display_get_default()), iconstr.c_str());
#endif
	...
	gtk_style_context_add_provider_for_display(
			gdk_display_get_default(), GTK_STYLE_PROVIDER(css_provider), GTK_STYLE_PROVIDER_PRIORITY_USER);
	...
	g_action_map_add_action_entries(G_ACTION_MAP(application), app_entries, G_N_ELEMENTS(app_entries), this);
	gtk_application_set_menubar(application, G_MENU_MODEL(get_gobject("main_menu_bar")));
	...
	gtk_window_set_application(GTK_WINDOW(app), application);    // GtkApplication
	gtk_widget_set_visible(app, true);
	GtkEventController* key_ctlr = GTK_EVENT_CONTROLLER(gtk_event_controller_key_new());
	gtk_event_controller_set_propagation_phase(key_ctlr, GTK_PHASE_CAPTURE);
	gtk_widget_add_controller(GTK_WIDGET(app), key_ctlr);
	g_signal_connect(G_OBJECT(key_ctlr), "key-pressed", G_CALLBACK(on_app_key_press), this);
...
void ExultStudio::connect_widget_signals(
	...
	if (GTK_IS_NOTEBOOK(widget)) {
		...
		for (GtkWidget* child = gtk_widget_get_first_child(widget); child; child = gtk_widget_get_next_sibling(child)) {
			connect_widget_signals(GTK_WIDGET(child), callback, user_data, excluded_names, num_excluded);
		}
	}
}
...
void ExultStudio::set_edit_terrain(gboolean terrain    // True/false
	...
	GAction* action = g_action_map_lookup_action(G_ACTION_MAP(application), "mode");
	g_action_change_state(action, g_variant_new_string(terrain ? "paint" : "move"));
}
...
int ExultStudio::prompt(
	...
	GtkWidget* prompt3_yes = get_widget("prompt3_yes");
	gtk_widget_set_halign(prompt3_yes, GTK_ALIGN_END);
	gtk_widget_set_hexpand(prompt3_yes, true);
	gtk_widget_set_hexpand(gtk_widget_get_parent(prompt3_yes), true);
	if (choice1) {
...
namespace EStudio {
	...
	GtkWidget* Create_arrow_button(
		...
		GtkWidget* img = gtk_image_new_from_icon_name(dir == GTK_ARROW_UP ? "go-up" : "go-down");
...
// X at top of window.
C_EXPORT gboolean on_prefs_window_delete_event(GtkWidget* widget, gpointer user_data) {
	ignore_unused_variable_warning(user_data);
...
void ExultStudio::open_preferences() {
	...
	gtk_drawing_area_set_draw_func(
			GTK_DRAWING_AREA(get_widget("prefs_background")), on_prefs_background_expose_event, this, nullptr);
	gtk_widget_set_visible(win, true);
}
...
void enable_submenu(GMenuModel* model, bool connected) {
	...
	for (int i = 0; i < nitems; i++) {
		...
		GVariant* item_action = g_menu_model_get_item_attribute_value(model, i, "action", EXULT_VARIANT_TYPE_STRING);
		if (item_action) {
			const gchar* action = g_variant_get_string(item_action, nullptr);
			if (g_strcmp0(action, "app.compile-usecode") != 0 && g_str_has_prefix(action, "app.")) {
				auto*          application = ExultStudio::get_instance()->get_application();
				GSimpleAction* gaction     = G_SIMPLE_ACTION(g_action_map_lookup_action(G_ACTION_MAP(application), &action[4]));
				if (gaction && g_action_get_enabled(G_ACTION(gaction)) != connected) {
...
void ExultStudio::update_menu_items(bool connected) {
	...
	for (int i = 0; i < nnodes; i++) {
		GVariant* node_label = g_menu_model_get_item_attribute_value(menubar, i, "label", EXULT_VARIANT_TYPE_STRING);
		if (node_label) {
			const gchar* label = g_variant_get_string(node_label, nullptr);
			if (g_strcmp0(label, "_Edit") == 0 || g_strcmp0(label, "_Mode") == 0 || g_strcmp0(label, "_Map") == 0
				|| g_strcmp0(label, "_Tools") == 0) {
				GMenuModel* submenu = g_menu_model_get_item_link(menubar, i, "submenu");
				enable_submenu(submenu, connected);
				g_object_unref(submenu);
			}
...
void ExultStudio::update_connect_button(bool connected) {
	...
	GtkWidget* label  = get_widget("connect_button_label");
	ignore_unused_variable_warning(image);

	if (!button || !image || !label) {
		return;
	}

	gtk_label_set_text(GTK_LABEL(label), connected ? "Disconnect" : "Connect");
...
void ExultStudio::update_play_button(bool playing) {
	...
	GtkWidget* label  = get_widget("play_button_label");
	...
	gtk_label_set_text(GTK_LABEL(label), playing ? "Edit" : "Play");

	if (playing) {
		gtk_image_set_from_icon_name(GTK_IMAGE(image), "media-playback-pause-symbolic");
	} else {
...
void ExultStudio::set_edit_menu(
	...
	g_simple_action_set_enabled(G_SIMPLE_ACTION(g_action_map_lookup_action(G_ACTION_MAP(application), "cut")), sel);
	g_simple_action_set_enabled(G_SIMPLE_ACTION(g_action_map_lookup_action(G_ACTION_MAP(application), "copy")), sel);
	g_simple_action_set_enabled(G_SIMPLE_ACTION(g_action_map_lookup_action(G_ACTION_MAP(application), "paste")), clip);
	g_simple_action_set_enabled(G_SIMPLE_ACTION(g_action_map_lookup_action(G_ACTION_MAP(application), "properties")), sel);
	g_simple_action_set_enabled(G_SIMPLE_ACTION(g_action_map_lookup_action(G_ACTION_MAP(application), "basic-properties")), sel);
}
...
gboolean ExultStudio::on_app_key_press(
		GtkEventControllerKey* key_ctlr, guint keyval, guint keycode, GdkModifierType state, gpointer user_data) {
