 ...
 */
C_EXPORT gboolean on_cont_window_delete_event(GtkWidget* widget, gpointer user_data) {
 ...
 */
C_EXPORT gboolean on_cont_pos_changed(GtkWidget* widget, GdkEvent* event, gpointer user_data) {
