...
public:
	...
	static void on_combo_draw_expose_event(GtkDrawingArea* widget, cairo_t* cairo, int x, int y, gpointer user_data);
...
public:
	...
	static gint configure(GtkWidget* widget, int width, int height, gpointer user_data);
	// Blit to screen.
