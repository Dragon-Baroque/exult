...
public:
	...
	// Menu items:
	static void obj_group_add_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
	// Add 'Add to group...' submenu.
	void        add_group_submenu(GMenu* popup);
	static void obj_file_save_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
	static void obj_file_revert_action(GSimpleAction* action, GVariant* parameter, gpointer user_data);
	...
	static void draw_vscrolled(GtkEventControllerScroll* self, gdouble dx, gdouble dy, gpointer user_data);
